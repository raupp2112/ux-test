...
document.addEventListener("DOMContentLoaded", () => {
    ...
    /* Updated Image paths specifically for Apple Mouse M4848 (.png format) 
       using ID '13' convention to maintain repository structure 
    */
    const frontImageSrc = "../images/simple_objects/13_apple_mouse_m4848/front_13.png";
    const backImageSrc = "../images/simple_objects/13_apple_mouse_m4848/back_13.png";

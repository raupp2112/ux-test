document.addEventListener("DOMContentLoaded", () => {
    ...
    // Updated paths specifically for Apple iPod mini (.png format) using ID '7'
    const frontImageSrc = "../images/simple_objects/7_apple_ipod_mini/front_7.png";
    const backImageSrc = "../images/simple_objects/7_apple_ipod_mini/back_7.png";

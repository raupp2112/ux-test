document.addEventListener("DOMContentLoaded", () => {
    ...
    // Updated paths specifically for Samsung SGH-A167 (.png format)
    const frontImageSrc = "../images/simple_objects/2_samsung_sgh/front_2.png";
    const backImageSrc = "../images/simple_objects/2_samsung_sgh/back_2.png";

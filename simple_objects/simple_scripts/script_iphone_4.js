document.addEventListener("DOMContentLoaded", () => {
    ...
    // Updated paths specifically for iPhone 4 (.png format) using ID '5'
    const frontImageSrc = "../images/simple_objects/5_iphone_4/front_5.png";
    const backImageSrc = "../images/simple_objects/5_iphone_4/back_5.png";

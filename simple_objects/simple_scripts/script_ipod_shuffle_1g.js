...
document.addEventListener("DOMContentLoaded", () => {
    ...
    /* Updated Image paths specifically for iPod shuffle 1st Gen (.png format) 
       using ID '12' convention to maintain repository structure 
    */
    const frontImageSrc = "../images/simple_objects/12_ipod_shuffle_1g/front_12.png";
    const backImageSrc = "../images/simple_objects/12_ipod_shuffle_1g/back_12.png";

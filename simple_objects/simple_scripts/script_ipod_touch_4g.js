...
document.addEventListener("DOMContentLoaded", () => {
    ...
    /* Updated Image paths specifically for iPod Touch 4G (.png format) 
       using ID '9' convention to maintain repository structure 
    */
    const frontImageSrc = "../images/simple_objects/9_ipod_touch_4g/front_9.png";
    const backImageSrc = "../images/simple_objects/9_ipod_touch_4g/back_9.png";

document.addEventListener("DOMContentLoaded", () => {
    ...
    // Updated paths specifically for Apple Mouse IIC (.png format) using '3'
    const frontImageSrc = "../images/simple_objects/3_apple_mouse/front_3.png";
    const backImageSrc = "../images/simple_objects/3_apple_mouse/back_3.png";

...
document.addEventListener("DOMContentLoaded", () => {
    ...
    /* Updated Image paths specifically for Microsoft Kin One (.png format) 
       using ID '10' convention to maintain repository structure 
    */
    const frontImageSrc = "../images/simple_objects/10_microsoft_kin_one/front_10.png";
    const backImageSrc = "../images/simple_objects/10_microsoft_kin_one/back_10.png";

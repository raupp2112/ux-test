...
document.addEventListener("DOMContentLoaded", () => {
    ...
    /* Updated Image paths specifically for Apple M7332 Yo-yo Adapter (.png format) 
       using ID '15' convention to maintain repository structure 
    */
    const frontImageSrc = "../images/simple_objects/15_apple_m7332/front_15.png";
    const backImageSrc = "../images/simple_objects/15_apple_m7332/back_15.png";

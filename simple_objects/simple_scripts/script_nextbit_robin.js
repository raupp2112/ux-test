...
document.addEventListener("DOMContentLoaded", () => {
    ...
    /* Updated Image paths specifically for Nextbit Robin (.png format) 
       using ID '11' convention to maintain repository structure 
    */
    const frontImageSrc = "../images/simple_objects/11_nextbit_robin/front_11.png";
    const backImageSrc = "../images/simple_objects/11_nextbit_robin/back_11.png";
